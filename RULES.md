...
> **Lưu ý:** Có biến thể đặt khác nhưng dự án này chốt theo layout trên (giống nhiều phiên bản chơi phổ biến). Nếu user muốn biến thể khác, ghi vào `BUGFIX.md` mục "Discussion".
...
. . .    . . .
```
*Ví dụ minh họa chỉ phần xung quanh, không phải toàn bàn.*
